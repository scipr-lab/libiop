    ...
    make_zk_(make_zk)
{
    ...
    for (size_t r = 0; r < this->num_rounds_; ++r)
    {
        ...
        for (size_t i = 0; i < this->num_oracles_per_round_; ++i)
        {
            ...
            const oracle_handle oracle_i_handle = 
                this->IOP_.register_oracle(this->codeword_domain_handle_, this->codeword_domain_size_ - 1, make_oracle_zk);
...
void dummy_protocol<FieldT>::calculate_and_submit_response()
{
    for (size_t r = 0; r < this->num_rounds_; ++r)
    {
        ...
        this->IOP_.obtain_verifier_random_message(this->verifier_msg_handles_[r]);
    }
}
