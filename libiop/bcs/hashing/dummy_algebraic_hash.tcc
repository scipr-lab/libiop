...
hash_data_type dummy_algebraic_hashchain<FieldT, hash_data_type>::squeeze_root_type_internal(
    const typename libiop::enable_if<std::is_same<hash_data_type, FieldT>::value, hash_data_type>::type dummy)
{
...
template<typename FieldT, typename hash_data_type>
hash_data_type dummy_algebraic_hashchain<FieldT, hash_data_type>::squeeze_root_type_internal(
    const typename libiop::enable_if<std::is_same<hash_data_type, binary_hash_digest>::value, hash_data_type>::type dummy)
{
