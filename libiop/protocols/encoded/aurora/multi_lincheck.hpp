/**@file
*****************************************************************************
Aurora R1CS multi lincheck oracle
*****************************************************************************
* @author     This file is part of libiop (see AUTHORS)
* @copyright  MIT license (see LICENSE file)
*****************************************************************************/
#ifndef LIBIOP_PROTOCOLS_ENCODED_AURORA_MULTI_LINCHECK_HPP_
#define LIBIOP_PROTOCOLS_ENCODED_AURORA_MULTI_LINCHECK_HPP_
...
#include "libiop/protocols/encoded/aurora/multi_lincheck_aux.hpp"
...
class multi_lincheck_parameters {
protected:
...
public:
    multi_lincheck_parameters() {};
    multi_lincheck_parameters(const size_t interactive_security_parameter,
...
#include "libiop/protocols/encoded/aurora/multi_lincheck.tcc"

#endif // LIBIOP_PROTOCOLS_ENCODED_AURORA_MULTI_LINCHECK_HPP_
