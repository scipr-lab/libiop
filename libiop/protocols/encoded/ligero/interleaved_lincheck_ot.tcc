                                                                              ...
                                                                              std::vector<std::vector<FieldT>> random_linear_combinations)
{
    ...
    libiop::enter_block("Input consistency");
    ...
    libiop::leave_block("Input consistency");
                                                                  ...
                                                                  std::vector<std::vector<FieldT>> lagrange_coefficients)
{
    ...
    for (size_t h = 0; h < this->num_interactions_; ++h)
    {
        ...
        libiop::enter_block("Lincheck: equality test (p_0 sums to 0 over systematic domain)");
        ...
        {
#ifdef DEBUG
            libiop::print_indent(); printf("For interactive repetition h = %zu\n", h);
        ...
        libiop::leave_block("Lincheck: equality test (p_0 sums to 0 over systematic domain)");
        ...
        if (!using_lagrange)
        {
            ...
            libiop::enter_block("Precomputing for consistency tests");
            ...
            libiop::leave_block("Precomputing for consistency tests");
        }

        libiop::enter_block("Lincheck: querying and performing consistency tests");
        for (size_t k = 0; k < this->num_queries_; ++k)
        {
            const random_query_position_handle this_position_handle = this->query_position_handles_[k];
            const std::size_t j = this->IOP_.obtain_query_position(this_position_handle);
            ...
            {
#ifdef DEBUG
                libiop::print_indent(); printf("For interactive repetition h = %zu and query position j = %zu,\n", h, j);
        ...
        libiop::leave_block("Lincheck: querying and performing consistency tests");
    }
